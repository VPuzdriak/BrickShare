...
| 3. Plan the recording order → `docs/course-plan/` | **Done for catalog** — episodes 1 to 38. |
| 4. Script and build, episode by episode | **Episodes 1–19 recorded and merged.** Episodes 20–27 are scripted but not implemented. Nothing from 28 on is written. |
