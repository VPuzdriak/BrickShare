...
| 3. Plan the recording order → `docs/course-plan/` | **Done for catalog** — episodes 1 to 36. |
| 4. Script and build, episode by episode | **Episodes 1–19 recorded and merged.** Episodes 20–26 are scripted but not implemented. Nothing from 27 on is written. |
