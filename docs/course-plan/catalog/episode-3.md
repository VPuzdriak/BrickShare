...
// Nothing is tagged yet — Postgres arrives in episode 16, Blob Storage in episode 34.
...
episode 37, when logging is configured properly, and is noted here so it does not look
forgotten.
