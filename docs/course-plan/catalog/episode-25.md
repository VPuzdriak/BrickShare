...
storage account in episode 36, an Entra tenant in episode 38. The first of those that the application
...
go on screen instead, and the breaker's real proof arrives in episode 39, when the traces show it
opening.
