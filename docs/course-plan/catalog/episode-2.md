...
With OpenAPI stripped until episode 32, this is how the endpoint gets called — VS Code and
...
| `builder.Services.AddOpenApi()` and `app.MapOpenApi()` | OpenAPI is episode 32. Removing it is what leaves the project with zero package references. |
