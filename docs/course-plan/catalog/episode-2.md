...
With OpenAPI stripped until episode 30, this is how the endpoint gets called — VS Code and
...
| `builder.Services.AddOpenApi()` and `app.MapOpenApi()` | OpenAPI is episode 30. Removing it is what leaves the project with zero package references. |
