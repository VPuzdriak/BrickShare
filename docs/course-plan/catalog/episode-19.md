...
This project has one migration. It will have several by episode 38 and none of this will be relevant.
...
- **A self-hosted runner breaks it immediately.** Move CI on-premises, to another cloud, or onto a
  ...
  debugged as one.
- **Episode 38 breaks it on purpose.** Moving the database behind a private endpoint with public
...
practised operation. Deployment slots and a rehearsed rollback are episode 38.
...
Episode 38 fixes that with a user-assigned identity, alongside slots.
